...
public protocol DGCJXSegmentedViewRTLCompatible: class {
    func segmentedViewShouldRTLLayout() -> Bool
    func segmentedView(horizontalFlipForView view: UIView?)
}

public extension DGCJXSegmentedViewRTLCompatible {
...
class DGCJXSegmentedRTLCollectionCell: UICollectionViewCell, DGCJXSegmentedViewRTLCompatible {
