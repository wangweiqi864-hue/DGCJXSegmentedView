 ...
 */
public struct DGCJXSegmentedIndicatorSelectedParams {
    public let currentSelectedIndex: Int
    public let currentSelectedItemFrame: CGRect
    public let selectedType: DGCJXSegmentedViewItemSelectedType
    public let currentItemContentWidth: CGFloat
    /// collectionView的contentSize
    public var collectionViewContentSize: CGSize?

    public init(currentSelectedIndex: Int, currentSelectedItemFrame: CGRect, selectedType: DGCJXSegmentedViewItemSelectedType, currentItemContentWidth: CGFloat, collectionViewContentSize: CGSize?) {
...
public struct DGCJXSegmentedIndicatorTransitionParams {
    public let currentSelectedIndex: Int
