//
//  DGCJXSegmentedIndicatorGradientLineView.swift
//  DGCJXSegmentedView
//
...
open class DGCJXSegmentedIndicatorGradientLineView: DGCJXSegmentedIndicatorLineView {
    ...
    open override func selectItem(model: DGCJXSegmentedIndicatorSelectedParams) {
        ...
        gradientLayer.frame.size.width = dgc_targetWidth
        CATransaction.commit()
    }
