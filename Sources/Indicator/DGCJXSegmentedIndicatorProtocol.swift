//
//  DGCJXSegmentedIndicatorProtocol.swift
//  DGCJXSegmentedView
//
...
public protocol DGCJXSegmentedIndicatorProtocol: UIView {
    ...
    func refreshIndicatorState(model: DGCJXSegmentedIndicatorSelectedParams)
    ...
    /// param percent 过渡百分比
    /// - Parameter model: model description
    func contentScrollViewDidScroll(model: DGCJXSegmentedIndicatorTransitionParams)
    ...
    /// - Parameter model: model description
    func selectItem(model: DGCJXSegmentedIndicatorSelectedParams)
}
