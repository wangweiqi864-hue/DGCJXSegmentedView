//
//  DGCJXSegmentedIndicatorRainbowLineView.swift
//  DGCJXSegmentedView
//
...
open class DGCJXSegmentedIndicatorRainbowLineView: DGCJXSegmentedIndicatorLineView {
    ...
    open override func contentScrollViewDidScroll(model: DGCJXSegmentedIndicatorTransitionParams) {
        ...
        backgroundColor = DGCJXSegmentedViewTool.interpolateColor(from: indicatorColors[model.leftIndex], to: indicatorColors[model.rightIndex], percent: model.percent)
    }
