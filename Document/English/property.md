...
## DGCJXSegmentedView Common Property

Property     | Description           |
--------------|---------------|
Indicators | elements must be UIView and its subclasses that follow the DGCJXSegmentedIndicatorProtocol protocol |
...
## DGCJXSegmentedViewDataSource Protocol Series Common Property

### DGCJXSegmentedBaseDataSource Common Property

Property     | Description           |
--------------|---------------|
dataSource | The data source array that is ultimately passed to DGCJXSegmentedView |
itemContentWidth | The content width of the cell is DGCJXSegmentedViewAutomaticDimension, which is based on the width of the content calculation. Otherwise, the specific value of itemContentWidth is used. |
itemWidthIncrement | true item width = itemContentWidth + itemWidthIncrement. |
itemSpacing | spacing before item |
isItemSpacingAverageEnabled | Whether itemSpacing is evenly divided when collectionView.contentSize.width is less than the width of DGCJXSegmentedView. |
isItemTransitionEnabled | whether the gradient is allowed when the item scrolls left and right. For example, DGCJXSegmentedTitleDataSource's titleZoom, titleNormalColor, titleStrokeWidth and other gradients. |
isSelectedAnimable | Whether an animation transition is required when selected. Custom cells need to handle animation transition logic themselves, animation processing logic reference `DGCJXSegmentedTitleCell` |
...
### DGCJXSegmentedTitleDataSource Common Property
...
### DGCJXSegmentedTitleImageDataSource Common Property

Property     | Description           |
--------------|---------------|
titleImageType | DGCJXSegmentedTitleImageType type, set the text image display type |
...
### DGCJXSegmentedTitleOrImageDataSource Common Property
...
### DGCJXSegmentedTitleGradientDataSource Common Property
...
### DGCJXSegmentedTitleAttributeDataSource Common Property
...
### DGCJXSegmentedNumberDataSource Common Property
...
### DGCJXSegmentedDotDataSource Common Property

Property     | Description           |
--------------|---------------|
dotStates | quantity needs to be consistent with titles, control whether red dot is displayed |
dotSize | Red dot size |
dotCornerRadius | Red dot fillet value, DGCJXSegmentedViewAutomaticDimension equals dotSize.height/2 |
...
## DGCJXSegmentedIndicatorProtocol Series Common Property

### DGCJXSegmentedIndicatorBaseView Common Property

Property     | Description           |
--------------|---------------|
indicatorWidth | Default DGCJXSegmentedViewAutomaticDimension (equal to the width of the cell). Internally get the actual value via the getIndicatorWidth method |
indicatorHeight | Default DGCJXSegmentedViewAutomaticDimension (equal to the height of the cell). Internally get the actual value via the getIndicatorHeight method |
indicatorCornerRadius | Default DGCJXSegmentedViewAutomaticDimension (equal to indicatorHeight/2). Internally get the actual value via the getIndicatorCornerRadius method |
...
### DGCJXSegmentedIndicatorLineView Common Property

Property     | Description           |
--------------|---------------|
lineStyle | DGCJXSegmentedIndicatorLineStyle Style |
lineScrollOffsetX | lineStyle is used for lengthenOffset, the offset of x when scrolling |


### DGCJXSegmentedIndicatorRainbowLineView Common Property
...
### DGCJXSegmentedIndicatorDotLineView Common Property

Property     | Description           |
--------------|---------------|
lineMaxWidth | maximum width of the line |

### DGCJXSegmentedIndicatorDoubleLineView Common Property

Property     | Description           |
--------------|---------------|
minLineWidthPercent | Line shrinks to the smallest percentage |

### DGCJXSegmentedIndicatorBackgroundView Common Property

Property     | Description           |
--------------|---------------|
backgroundWidthIncrement | width increment, background indicator is generally wider than cell |

### DGCJXSegmentedIndicatorTriangleView Common Property

Use the attribute inherited from `DGCJXSegmentedIndicatorBaseView`

### DGCJXSegmentedIndicatorImageView Common Property

Property     | Description           |
--------------|---------------|
Image | Set indicator picture |

### DGCJXSegmentedIndicatorGradientView Common Property
...
## DGCJXSegmentedListContainerView Common Property
...
dataSource | DGCJXSegmentedListContainerViewDataSource class |
